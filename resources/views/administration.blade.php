...
<body>
  ...
  <section id="actions" class="py-4 mb-4 bg-light">
    <div class="container">
      <div class="row">
        <div class="col-md-2">
          <a href="#" class="btn btn-primary btn-block" data-toggle="modal" data-target="#addnotesModal">
            <i class="fas fa-share"></i> Send notes
          </a>
        </div>
        <div class="col-md-2">
          <a href="#" class="btn btn-dark btn-block" data-toggle="modal" data-target="#addcalendarModal">
            <i class="fas fa-share"></i>  Send calandar
          </a>
        </div>
        <div class="col-md-2">
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header bg-primary text-white">
          <h5 class="modal-title">Send notes</h5>
          <button class="close" data-dismiss="modal">
            <span>&times;</span>
          </button>
        </div>
          ...
          <form>
            ...
            <div class="form-group">
              ...
              <select class="form-control">
                <option value="">EMD1</option>
                <option value="">EMD2</option>
                <option value="">EMD3</option>
                <option value="">EMD4</option>
                <option value="">TD</option>
              </select>
            </div>
            <div class="form-group">
              <label for="text">la note</label>
              <input type="text" class="form-control">
            </div>
